...
# resultsPP <- rbind(resultsPP, rep(NA, ncol(resultsPP)))
...
# wppp<-abs(resultsWP$OLS/resultsPP$OLS)
# wppp <- wppp[wppp<1000]
...
# wppp_FE<-abs(resultsWP$FE/resultsPP$FE)
...
# wppp_BE<-abs(resultsWP$BE/resultsPP$BE)
